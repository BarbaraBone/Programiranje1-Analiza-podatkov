...
def zadetek(vzorec, ime_skupine, knjiga):
    """Funkcija poišče v posamezni knjigi, najde glede na dan vzorec in ime skupine v vzorcu zadetek"""
...
def knjiga_v_slovar(knjiga):
    """Funkcija iz niza za posamezeno knjigo izlušči podatke o avtorju, naslovu dela, oceno, število ocen
    in število volilcev, ki je za knjigo glasovalo, da je na seznamu"""
